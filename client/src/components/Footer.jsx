...
export default function FooterCom() {
  return (
    <Footer className="border border-t-8 border-purple-500">
      <div className="w-full max-w-7xl mx-auto px-5">
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            <div>
                ...
                <Footer.LinkGroup col>
                    ...
                    <Footer.Link href="/about" target="_blank" rel="noopener noreferrer">Rahul's Blog</Footer.Link>
                </Footer.LinkGroup>
            </div>
            <div>
        ...
        <Footer.Divider/>
        <div className="w-full mb-2 sm:flex sm:items-center sm:justify-between">
            <Footer.Copyright href="#" by="Rahul's Blog" year={new Date().getFullYear()}/>
